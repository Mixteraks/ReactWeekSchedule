    ...
    <>
          ...
          {DAYS.map((day, index) => (
            <div key={index} className={styles.header}>
              ...
              <p className={styles.hour} style={{ textAlign: 'center' }}>
                {getweeknumFromDate(weekStart)[index].day}
              </p>
            </div>
          ))}
                ...
                return (
                  <DaySegment
                    onClick={() =>
                      setMoreInfo({
                        enabled: true,
                        date: { hour, dayIndex: dayIndex, fullDate: getweeknumFromDate(weekStart)[dayIndex].date },
                        avilable: isActive,
                      })
                    }
                    key={`${hourIndex}-${dayIndex}`}
      ...
      {showMoreInfo.enabled && (
        <div className={styles.moreInfo}>
          <div>
            <p>
              {getFullDayName(showMoreInfo.date.dayIndex)} {showMoreInfo.date.hour}
            </p>
              ...
              <Button
                onClick={() => {
                  if (onSetStartDate) {
                    ...
                    date.setDate((showMoreInfo.date.fullDate as Date).getDate())
